...
class Face_Recognition:
    def __init__(self,root):
        ...
        #first image
        img_top=Image.open(r"images\hero-facial-recognition.jpg")
        ...
        #button
        b1_1=Button(f_lbl,text="Face Recognition",cursor="hand2",font=("times new roman",18,"bold"),bg="darkblue",fg="white",command=self.face_recog)
